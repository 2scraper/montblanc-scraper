...
**"montblanc-scraper security"** in the subject — otherwise it lands in a queue
...
- **Bypassing Montblanc's bot protection.** This scraper drives an ordinary
...
- **The scraper stopped working.** Montblanc changing its markup is expected —
